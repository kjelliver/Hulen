<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Hulen.WebCode.ViewModels.AccessGroupEditModel>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Hulen - Slett tilgangsgruppe
</asp:Content>
...
<div class="errormessage">
    ...
    <h2>Slett tilgangsgruppe</h2>
        ...
        <p>
            <input type="submit" name="delete" id="save" value="Slett tilgangsgruppe" />
        </p>
